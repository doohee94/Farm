...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form" class="register-form" action="owner_regist.farm" method="post">
			<h2>Please Sign Up <small>동상이농</small></h2>
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
                        <input type="text" name="ownerId" id="ownerId" class="form-control input-lg" placeholder="ID를입력하세요" tabindex="1">
					</div>
				</div>		
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
			...
			<div class="form-group">
				<input type="text" name="ownerName" id="ownerName" class="form-control input-lg" placeholder="이름을 입력하세요" tabindex="3">
			</div>
			<div class="form-group">
				<input type="text" name="ownerPhone" id="ownerPhone" class="form-control input-lg" placeholder="연락처를 입력하세요" tabindex="4">
			</div>
			<div class="form-group">
				<input type="text" name="ownerAccount" id="ownerAccount" class="form-control input-lg" placeholder="계좌번호를 입력하세요" tabindex="4">
			</div>
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="password" name="ownerPass" id="ownerPass" class="form-control input-lg" placeholder="Password" tabindex="5">
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
