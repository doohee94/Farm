...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">분양신청 거절</div>
      <div class="card-body">
        <form action="rejectRegister.farm">
        
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputName">구역이름</label>
                <input class="form-control" type="text" aria-describedby="nameHelp" value="${regionName }">
              </div>
            </div>
          </div>
          
          <div class="form-group">
            <label for="exampleInputEmail1">신청거절사유</label>
            <input name="reason" class="form-control" id="reason" type="text" aria-describedby="emailHelp" placeholder="거절 사유를 입력해주세요">
            <input type="hidden" name="rentNum" value="${rentNum}">
          </div>
          <input type="submit" class="btn btn-primary btn-block" value="등록">
          <div>**거절 사유는 이메일로 해당 회원의 이메일로 전송됩니다.</div>
        </form>
      </div>
    </div>
  </div>
