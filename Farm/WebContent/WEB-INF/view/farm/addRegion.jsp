  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">구역추가</li>
      </ol>
      <div class="row">
        <div class="col-12">
    ...
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
        <form action="addRegion.farm">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputName">구역이름</label>
                <input name="regionName" class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" placeholder="구역이름">
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputName">구역면적</label>
                <input name="regionSize" class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" placeholder="구역면적">
              </div>
            </div>
          </div>
           <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputName">임대최대기간</label>
                <input name="regionMaxrentterm" class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" placeholder="ex)3">달
              </div>
            </div>
            <div class="form-row">
              <div class="col-md-6">
                <label for="exampleInputName">구역 가격</label>
                <input name="regionPrice" class="form-control" id="exampleInputName" type="text" aria-describedby="nameHelp" placeholder="ex)20000">원/1달
              </div>
            </div>
          </div>
          <input type="hidden" id="farmNum" name="farmNum" value="${farmNum}">
